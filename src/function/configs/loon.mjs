...
[Rule]
AND,((DOMAIN-SUFFIX,weatherkit.apple.com),(PROTOCOL,QUIC),(DEST-PORT,443)),REJECT
AND,((IP-CIDR,139.178.128.0/18,no-resolve),(PROTOCOL,UDP),(DEST-PORT,443)),REJECT
AND,((IP-CIDR,144.178.0.0/19,no-resolve),(PROTOCOL,UDP),(DEST-PORT,443)),REJECT
AND,((IP-CIDR,144.178.36.0/22,no-resolve),(PROTOCOL,UDP),(DEST-PORT,443)),REJECT
AND,((IP-CIDR,144.178.48.0/20,no-resolve),(PROTOCOL,UDP),(DEST-PORT,443)),REJECT
AND,((IP-CIDR,17.0.0.0/8,no-resolve),(PROTOCOL,UDP),(DEST-PORT,443)),REJECT
AND,((IP-CIDR,192.35.50.0/24,no-resolve),(PROTOCOL,UDP),(DEST-PORT,443)),REJECT
AND,((IP-CIDR,198.183.17.0/24,no-resolve),(PROTOCOL,UDP),(DEST-PORT,443)),REJECT
AND,((IP-CIDR,205.180.175.0/24,no-resolve),(PROTOCOL,UDP),(DEST-PORT,443)),REJECT
AND,((IP-CIDR6,2403:300::/32,no-resolve),(PROTOCOL,UDP),(DEST-PORT,443)),REJECT
AND,((IP-CIDR6,2620:149::/32,no-resolve),(PROTOCOL,UDP),(DEST-PORT,443)),REJECT
AND,((IP-CIDR6,2a01:b740::/32,no-resolve),(PROTOCOL,UDP),(DEST-PORT,443)),REJECT
AND,((IP-CIDR,63.92.224.0/19,no-resolve),(PROTOCOL,UDP),(DEST-PORT,443)),REJECT
AND,((IP-CIDR,65.199.22.0/23,no-resolve),(PROTOCOL,UDP),(DEST-PORT,443)),REJECT
